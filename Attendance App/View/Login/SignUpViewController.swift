...
extension SignUpViewController {
    func style() {
        ...
        subHeader.text = "Please fill Fullname, No. KTP, Ship & Password to register your app"
        ...
        titleFullName.translatesAutoresizingMaskIntoConstraints = false
        titleFullName.text = "Full Name"
        titleFullName.font = .systemFont(ofSize: 16, weight: .medium)
        titleFullName.textColor = .systemGray
        ...
        registButton.setTitle("Register", for: .normal)
        ...
        styleTextField(fullNameTextField, withText: "Employee Fullname", isSecure: false)
    ...
    func layout() {
        ...
        stackView.addArrangedSubview(titleFullName)
        ...
        NSLayoutConstraint.activate([
            ...
            stackView.centerYAnchor.constraint(equalTo: containerView.centerYAnchor, constant: -100),
            ...
            userNameTextField.bottomAnchor.constraint(equalTo: titleFullName.topAnchor),
            
            titleFullName.bottomAnchor.constraint(equalTo: fullNameTextField.topAnchor),
            
            fullNameTextField.widthAnchor.constraint(equalTo: userNameTextField.widthAnchor),
            fullNameTextField.heightAnchor.constraint(equalTo: userNameTextField.heightAnchor),
            fullNameTextField.bottomAnchor.constraint(equalTo: titlePassword.topAnchor),
